...
const EVENTS = [
  {
    ...
    time: "23:00 — 10:00",
    lineup: ["Jadette", "PROXIMA-7", "HAUS ARKANA"],
  ...
  },
  {
    ...
    time: "22:00 — 08:00",
    lineup: ["NULLSPACE", "VØID SIGNAL", "K.REITER"],
    status: "SOLD OUT",
  },
  {
    id: "E-03",
    ...
    time: "00:00 — 09:00",
    lineup: ["HAUS ARKANA", "PROXIMA-7", "LUX NOCTEM"],
    status: "PRESALE",
  },
  {
    id: "E-04",
    ...
    date: "FRI 07 NOV 2026",
    time: "23:00 — 09:00",
    lineup: ["K.REITER", "NULLSPACE", "VØID SIGNAL"],
    status: "TICKETS AVAILABLE",
  },
];
